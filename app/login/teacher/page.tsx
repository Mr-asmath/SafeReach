          ...
          <div className="bg-gradient-to-r from-[#006b5f] to-[#047857] p-6 text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-label-sm">GuardianTrack Pro</p>
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
              ...
              <div className="space-y-1 text-label-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-bold text-green-900">teacher@demo.guardiantrack.edu</span>
                </div>
                <div className="flex justify-between">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input id="email" required type="email" defaultValue="teacher@demo.guardiantrack.edu" className="w-full pl-11 pr-4 py-3 bg-surface-container border border-outline-variant rounded-xl focus:border-secondary focus:ring-1 focus:ring-secondary outline-none text-body-md" />
                </div>
              </div>
              <div className="space-y-1.5">
                <div className="flex justify-between">
                  <label className="text-label-md text-on-surface-variant font-medium" htmlFor="password">Password</label>
                  <button type="button" className="text-label-sm text-secondary hover:underline">Forgot?</button>
                </div>
                <div className="relative">
