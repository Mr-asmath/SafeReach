            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-6">
              ...
              <div className="space-y-1 text-label-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-bold text-orange-900">parent@demo.guardiantrack.edu</span>
                </div>
                <div className="flex justify-between">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input id="email" required type="email" defaultValue="parent@demo.guardiantrack.edu" className="w-full pl-11 pr-4 py-3 bg-surface-container border border-outline-variant rounded-xl focus:ring-1 outline-none text-body-md" style={{borderColor: 'rgb(180 83 9 / 0.4)'}} />
                </div>
              </div>
              <div className="space-y-1.5">
                <div className="flex justify-between">
                  <label className="text-label-md text-on-surface-variant font-medium" htmlFor="password">Password</label>
                  <button type="button" className="text-label-sm text-[#92400e] hover:underline">Forgot?</button>
                </div>
                <div className="relative">
