    ...
    <main className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-20 py-12 max-w-xl w-full mx-auto lg:mx-0">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="font-headline-md text-headline-md text-primary font-bold leading-tight">GuardianTrack Pro</h1>
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-label-sm">
            ...
            <span className="font-mono font-bold text-on-surface">admin@demo.guardiantrack.edu</span>
            ...
            <form onSubmit={handleCredentials} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input id="email" required type="email" defaultValue="admin@demo.guardiantrack.edu" className="w-full pl-11 pr-4 py-3 bg-surface-container border border-outline-variant rounded-xl focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all text-body-md" placeholder="admin@school.edu" />
                </div>
              </div>
              <div className="space-y-1.5">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-primary-container flex-col items-center justify-center p-16 text-on-primary relative overflow-hidden">
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-on-primary/80 text-body-md leading-relaxed">GuardianTrack Pro provides the most advanced real-time tracking and safety management suite for modern educational institutions.</p>
